...
if (isset($_POST['email'])) {
    ...
    header("Location: ../php/correo_contrasenya.php");
    exit; 
}
                ...
                <div class="panel panel-login">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <p>Introduzca la dirección de correo electrónico asociado a su cuenta. </p>
                        </div>
                        <hr>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="cambiarContrasenya.php" method="post" role="form" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type="submit" name="enviar" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Enviar">
                                                <br><br>
                                                <?php
                                                if (isset($_SESSION['error'])) {
                                                    echo "<p class='no_registrado'>El correo no se encuentra registrado.</p>";
